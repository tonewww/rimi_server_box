    ...
    test('Test SSH connection with ED25519 key authentication', () async {
      ...
      try {
        ...
        config.ref
          ...
          ..password =
              nullptr // No password, using key
          ..private_key = privateKey.cast()
          ..passphrase =
              nullptr // No passphrase for this key
          ..timeout_secs = 10;
        ...
        if (config.ref.private_key != nullptr)
          malloc.free(config.ref.private_key);
        malloc.free(config);
      }
    });
    ...
    test('Test SSH connection with password (expected to fail)', () {
      ...
      try {
        ...
        expect(
          sessionId,
          equals(0),
          reason: 'Password auth should fail for this user',
        );
